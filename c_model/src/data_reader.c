...
static void get_file_paths(int dataset_id, char *training_emg_file, char *training_labels_file, char *testing_emg_file, char *testing_labels_file) {
    sprintf(training_emg_file, "c_model/data/dataset%02d/training_emg.csv", dataset_id);
    sprintf(training_labels_file, "c_model/data/dataset%02d/training_labels.csv", dataset_id);
    sprintf(testing_emg_file, "c_model/data/dataset%02d/testing_emg.csv", dataset_id);
    sprintf(testing_labels_file, "c_model/data/dataset%02d/testing_labels.csv", dataset_id);
}
