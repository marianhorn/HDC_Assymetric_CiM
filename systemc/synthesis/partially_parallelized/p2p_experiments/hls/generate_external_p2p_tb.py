...
def generate(rtl_path, out_path):
    ...
    with open(out_path, "w") as out:
        ...
        out.write("    function automatic integer expected_sample_checksum(input integer kind, input integer value);\n")
        out.write("        integer i;\n")
        out.write("        integer sample;\n")
        out.write("        begin\n")
        out.write("            sample = 0;\n")
        ...
        out.write("                sample = (sample + ((value + kind + 3 * i) & 8'hff)) & 16'hffff;\n")
        out.write("            end\n")
        out.write("            expected_sample_checksum = sample & 16'hffff;\n")
        out.write("        end\n")
        out.write("    endfunction\n\n")
        ...
        out.write("                scalar_sample_checksum = expected_sample_checksum(kind, value);\n")
        ...
        out.write("`ifdef P2P_ENCODER_MIMIC\n")
        out.write("                expected_value = 10 + received;\n")
        out.write("                expected_sample = expected_sample_checksum(expected_kind, expected_value);\n")
        out.write("                expected_encoded = expected_encoded_checksum(expected_kind, expected_value);\n")
        out.write("`else\n")
        out.write("                expected_value = 11 + received;\n")
        out.write("                expected_sample = 0;\n")
        out.write("                expected_encoded = 0;\n")
        out.write("`endif\n")
