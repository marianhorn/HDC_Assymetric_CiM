...
set out_dir vivado_synth_hdc_smallfpga
...
if {![file exists $top_rtl]} {
    error "Missing HLS top RTL: $top_rtl. Run HLS with project_smallfpga.tcl first."
}
if {[llength $generated_rtl] == 0} {
    error "Missing generated memory RTL under $hls_dir/v_rtl. Run HLS with project_smallfpga.tcl first."
}
