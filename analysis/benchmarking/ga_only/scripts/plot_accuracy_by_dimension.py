#!/usr/bin/env python3
"""Plot seed-averaged GA-only accuracy over dimensions at fixed levels."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot one GA-only accuracy line per dataset over dimensions."
    )
...
def main() -> None:
    ...
    output = args.output or (
        DEFAULT_PLOTS_DIR
        / (
            f"ga_only_levels_{args.num_levels:03d}_{args.phase}_{args.split}"
