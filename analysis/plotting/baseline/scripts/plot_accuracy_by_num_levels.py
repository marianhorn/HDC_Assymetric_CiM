#!/usr/bin/env python3
"""Plot seed-averaged baseline accuracy over quantization levels at fixed dimension."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot one baseline accuracy line per dataset over quantization levels."
    )
...
def main() -> None:
    ...
    output = args.output or (
        DEFAULT_PLOTS_DIR
        / (
            f"baseline_dimension_{args.vector_dimension}_{args.phase}_{args.split}"
