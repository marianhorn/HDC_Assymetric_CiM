...
#include "../foot/dataReaderFootEMG.h"
...
static void usage(const char *prog) {
    fprintf(stderr,
            ...
            "Default cim_generation_dir: CiMs/ga_run_20260811_133846_01_dataset03_seed01_l40_d10000_pop128_gen64/generation_0064\n"
            "Default dataset: 3\n",
            prog);
}

int main(int argc, char **argv) {
    const char *cim_dir = "CiMs/ga_run_20260811_133846_01_dataset03_seed01_l40_d10000_pop128_gen64/generation_0064";
    int dataset = 3;
