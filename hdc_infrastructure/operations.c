 ...
 * - **Bundling:** Aggregates multiple binary vectors using majority voting.
 ...
 *
 * @details
 * These operations form the core of data encoding, aggregation,
 ...
 *
 * Performs binding by applying XOR on corresponding packed words.
 *
 ...
 *
 * Bundling combines two binary vectors by strict majority.
 *
 * @param vector1 The first input vector.
 * @param vector2 The second input vector.
 ...
 *
 * Combines an array of vectors into a single bundled vector by majority voting.
 *
...
/**
 * @brief Computes normalized Hamming similarity between two binary vectors.
 *
 * @param vec1 The first input vector.
 * @param vec2 The second input vector.
 * 
