 ...
 * 
 * Binary hypervectors are pre-bundled for each class before updating associative memory.
 *
 ...
 *
 * @note 
 * - Hypervectors are pre-bundled for each class and then added.
 *
 * @warning 
 ...
 * - Stable n-grams are encoded into hypervectors, which are bundled per class and added to the associative memory.
 */
 ...
 *
 * @note 
 * - Pre-bundling of class hypervectors is necessary before updates.
 *
 * @details 
