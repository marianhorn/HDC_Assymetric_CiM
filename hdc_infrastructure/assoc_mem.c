 ...
 * classify new input vectors, and load/save memory.
 *
 * @author Marian Horn
 */
 ...
 *
 * @details
 * Sets the class vector to the supplied binary hypervector.
 *
 ...
 * Each vector is stored as packed binary words.
 * 
 ...
 *
 * Each vector is read as packed binary words.
 * 
